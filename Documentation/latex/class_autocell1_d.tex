...
\index{Autocell1D@{Autocell1D}!````~Autocell1D@{$\sim$\+Autocell1D}}
\index{````~Autocell1D@{$\sim$\+Autocell1D}!Autocell1D@{Autocell1D}}
\subsubsection[{\texorpdfstring{$\sim$\+Autocell1\+D()}{~Autocell1D()}}]{\setlength{\rightskip}{0pt plus 5cm}virtual Autocell1\+D\+::$\sim$\+Autocell1D (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [virtual]}}\hypertarget{class_autocell1_d_a6e0394ef052472c6e23dd1bdd4c3dcd2}{}\label{class_autocell1_d_a6e0394ef052472c6e23dd1bdd4c3dcd2}
